      ...
      <div class="column mr-4">
        ...
        >
          <b-tab-item>
            <div class="level">
              <div class="level-left">
                <p class="subtitle is-4">Table Pelatihan</p>
              </div>
              <div class="level-right">
          ...
          <b-tab-item>
            ...
            <b-field expanded>
              ...
              <b-field>
                ...
                <b-input placeholder="Name" v-model="selected.nama_mentor" expanded></b-input>
              </b-field>
            </b-field>
            <b-field expanded>
              <template #label>
              ...
              <b-field>
                ...
                <b-input placeholder="Name" v-model="selected.kontak_mentor" expanded></b-input>
              </b-field>
            </b-field>
          </b-field>
           <hr />
        ...
        >
          ...
          >
            ...
            <div class="media-content pl-4">
              <p class="title is-6">{{ selected.nama_mentor }}</p>
              <p class="subtitle is-6">Kontak : {{ selected.kontak_mentor }}</p>
            </div>
          </div>
            <p class="title is-4">
              {{ selected.nama_ide }}
