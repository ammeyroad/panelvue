<template>
  <div class="columns is-multiline">
        ...
        <div class="card-content">
          <div class="content">
            <div class="columns is-multiline">
              ...
              <div class="column is-4">
                <p class="heading">Sumber Dana</p>
                <p class="title is-size-5">
                  {{ application.source_of_fund }}
                </p>
              </div>
    ...
    <div class="column is-12">
      <div class="card is-shadowless">
        <div class="card-header">
          <div class="card-header-title">Data Rekening</div>
        </div>
        ...
        <div class="card-content">
          <div class="content">
            <div class="columns is-multiline">
              <div class="column is-4">
                <div>
                  <p class="heading">Nominal Setoran Awal</p>
                  <p class="title is-size-5">
                    {{ currencyLabel(application.initial_deposit_amount) }}
                  </p>
                </div>
              </div>

              <div class="column is-4">
                <p class="heading">Tujuan Pembukaan Rekening</p>
                <p class="title is-size-5">
                  {{ application.account_purpose }}
                </p>
              </div>
